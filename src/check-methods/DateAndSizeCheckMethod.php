 ...
 */
class DateAndSizeCheckMethod extends CheckMethod
{
    ...
    {
        $file = urldecode($file);
        $filePath = SUpdateServer::FILES_DIRECTORY . "/" . $file;

        return array("fileRelativePath" => $file, "size" => filesize($filePath), "date" => filemtime($filePath));
    }
}
