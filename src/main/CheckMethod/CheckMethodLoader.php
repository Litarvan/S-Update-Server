...
class CheckMethodLoader
{
     ...
     */
    const DEFAULT_FOLDER = "check-methods";

    /**
     * CheckMethodLoader constructor.
     *
     * @param $folder string The folder where the check methods are
     */
     ...
     *
     * @param $checkMethod string The check method name to check if it is loaded
     *
     * @return bool If the check method is loaded
     */
     ...
     *
     * @param $checkMethod string The check method name to get
     *
     * @return CheckMethod | false The Check Method if found, or false if not
     */
     ...
     *
     * @return CheckMethodLoader The current CheckMethodLoader
     */
